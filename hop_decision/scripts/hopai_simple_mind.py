...
class Hopai(object):
    ...
    mode_pub   = rospy.Publisher('chassis_mode',intInt, queue_size=1)
...
####################################################
    def turn_to_target(self):
        ...
        else if self.being_hit:
            if self.hit_armor == 1:
                pass
            else if self.hit_armor == 0:
                self.goal_pose[2] -= 1.5708
            else if self.hit_armor == 2:
                self.goal_pose[2] += 1.5708
            else if self.hit_armor == 3:
